<?php get_header(); ?>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"LocalBusiness","name":"<?php echo esc_js( pasc_company_name() ); ?> — Southwest Florida","areaServed":{"@type":"AdministrativeArea","name":"Southwest Florida"},"telephone":"+1-800-394-7665","url":"<?php echo esc_url( get_permalink() ); ?>"}</script>
